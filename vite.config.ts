...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        // Precache the exercise GIFs, mobility videos + machine photos too, so demos work offline in the gym.
        globPatterns: ['**/*.{js,css,html,svg,png,gif,jpg,jpeg,webp,mp4,webmanifest}'],
